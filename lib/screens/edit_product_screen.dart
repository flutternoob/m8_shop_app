...
/*
When working with Forms, you typically have multiple input fields above each other -
that's why you might want to ensure that the list of inputs is scrollable.
Especially, since the soft keyboard will also take up some space on the screen.
...
For short lists/ portrait-only apps, where only minimal scrolling might be needed,
a ListView should be fine, since items won't scroll that far out of view (ListView
...
class EditProductScreen extends StatefulWidget {
  ...
  EditProductScreen(this.editProduct, {Key? key}) : super(key: key);
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    _editedProduct = widget.editProduct;
...
class _EditProductScreenState extends State<EditProductScreen> {
  //Creating focus nodes not compulsory with Flutter 3.0 as focus changes automatically
  //to next field
  final _priceFocusNode = FocusNode();
  final _descriptionFocusNode = FocusNode();
  final _imageUrlController = TextEditingController();
